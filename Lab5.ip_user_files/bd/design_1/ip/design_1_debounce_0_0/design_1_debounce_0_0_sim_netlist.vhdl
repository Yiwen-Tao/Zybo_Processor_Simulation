...
--               Tao/Desktop/Embedded/Lab5/Lab5.srcs/sources_1/bd/design_1/ip/design_1_debounce_0_0/design_1_debounce_0_0_sim_netlist.vhdl}
...
architecture STRUCTURE of design_1_debounce_0_0_debounce is
  ...
  signal count_reg : STD_LOGIC_VECTOR ( 21 downto 0 );
...
dbnc_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
dbnc_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
dbnc_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
dbnc_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
entity design_1_debounce_0_0 is
  ...
  attribute x_core_info of design_1_debounce_0_0 : entity is "debounce,Vivado 2016.4";
